...
def run2d1(base_models=None,ensemble_models=None):
    # Number 1 dataset
...
def run2d2(base_models=None,ensemble_models=None):
    # Number 2 dataset
...
def run2d3(base_models=None,ensemble_models=None):
    # Number 3 dataset
...
def run2d4(base_models=None,ensemble_models=None):
    # Number 4 dataset
...
def run2d5(base_models=None,ensemble_models=None):
    # Number 5 dataset
    # '''
    # load the data
...
def run2d6(base_models=None,ensemble_models=None):
    # Number 6 dataset
...
def run2d7(base_models=None,ensemble_models=None):
    # Number 7 dataset
...
def run2d8(base_models=None,ensemble_models=None):
    # Number 8 dataset
...
#########################################################################################################################################################################################
def run3d1(base_models=None,ensemble_models=None):
    # Number 1 dataset
...
def run3d2(base_models=None,ensemble_models=None):
    # Number 2 dataset
    fields = ["RMSD", "F1", "F2", "F3", "F4", "F5", "F6", "F7", "F8", "F9"]
    fields = ["RMSD", "F3", "F5"]
...
def run3d3(base_models=None,ensemble_models=None):
    # Number 3 dataset
...
def run3d4(base_models=None,ensemble_models=None):
    # Number 4 dataset
...
def run3d5(base_models=None,ensemble_models=None):
    # Number 5 dataset
    # '''
    # load the data
    fields = ['Temperature', 'Exhaust_Vacuum', 'Ambient_Pressure', 'Relative_Humidity', 'energy_output']
...
def run3d6(base_models=None,ensemble_models=None):
    # Number 6 dataset
...
def run3d7(base_models=None,ensemble_models=None):
    # Number 7 dataset
...
def run3d8(base_models=None,ensemble_models=None):
    # Number 8 dataset
...
#########################################################################################################################################################################################
def run1(base_models=None,ensemble_models=None):
    # Number 1 dataset
...
def run2(base_models=None,ensemble_models=None):
    # Number 2 dataset
    fields = ["RMSD", "F1", "F2", "F3", "F4", "F5", "F6", "F7", "F8", "F9"]
    #fields = ["RMSD", "F3", "F5"]
...
def run3(base_models=None,ensemble_models=None):
    # Number 3 dataset
...
def run4(base_models=None,ensemble_models=None):
    # Number 4 dataset
...
def run5(base_models=None,ensemble_models=None):
    # Number 5 dataset
    # '''
    # load the data
    fields = ['Temperature', 'Exhaust_Vacuum', 'Ambient_Pressure', 'Relative_Humidity', 'energy_output']
...
def run6(base_models=None,ensemble_models=None):
    # Number 6 dataset
...
def run7(base_models=None,ensemble_models=None):
    # Number 7 dataset
...
def run8(base_models=None,ensemble_models=None):
    # Number 8 dataset
...
if __name__ == "__main__":
    ...
    # client.test_logger()
    run2d5(base_models=["sklearn_linear", "sklearn_poly"],ensemble_models=["sklearn_gradient_tree_boosting", "xgboost"])
