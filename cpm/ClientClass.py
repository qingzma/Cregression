...
class ClientClass:
    ...
    def fit(self, training_data_model, training_data_classifier, testing_data, b_select_classifier=False):
    ...
    def matplotlib_plot_2D(self, answers, b_show_division_boundary=True, b_show_god_classifier=False, y_classifier=None,
        ...
        if b_show_division_boundary:
            ...
            for i in range(len(self.app_names_for_classifier)):
                X, Y = dt.get_values_equal_to_(i, answers.get_vispy_plot_data_2d()[:, 0], answers.modelID)
                # print(X)
                if X != []:
    ...
    def run2d(self, data):
        ...
        statistics.NRMSE_ideal = dt.NRMSE(errors_ideal, answers_for_testing[0].labels)
...
if __name__ == "__main__":
    ...
    predictions0 = cs.get_predictions(models[0], training_data_classifier)
